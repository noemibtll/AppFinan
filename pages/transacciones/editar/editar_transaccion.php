        ...
        >
            ...
            <div class="mb-3">
                ...
                <select name="categoria" id="categoria" class="form-select" required>
                    <option value="0" <?php if ($id_categoria == 0) echo "selected"; ?>>Seleccionar</option>
                    <option value="1" <?php if ($id_categoria == 1) echo "selected"; ?>>Alimentación</option>
                    <option value="2" <?php if ($id_categoria == 2) echo "selected"; ?>>Transporte</option>
                    <option value="3" <?php if ($id_categoria == 3) echo "selected"; ?>>Nómina</option>  
                    <option value="4" <?php if ($id_categoria == 4) echo "selected"; ?>>Ahorro</option>
                    <option value="5" <?php if ($id_categoria == 5) echo "selected"; ?>>Hogar</option>
                    <option value="6" <?php if ($id_categoria == 6) echo "selected"; ?>>Salud</option>
                    <option value="7" <?php if ($id_categoria == 7) echo "selected"; ?>>Entretenimiento</option>                    
