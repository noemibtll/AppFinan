...
<head>
    ...
    <script src="<?php echo JS_DIR; ?>/usuario_js/agregar_usuario.js"></script>
...
<body class="bg-light">
    ...
    <div class="container mt-5">
        ...
        <form id="agregar_usuario" name="agregar_usuario" method="post" action="<?php echo PHP_DIR; ?>/registro/agregar.php" enctype="multipart/form-data">
            <div class="mb-3">
